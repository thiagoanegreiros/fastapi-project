...
from adapters.inbound.auth import create_access_token
from adapters.inbound.routes import login_router
...
@pytest.mark.asyncio
@patch(
    "adapters.inbound.routes.login_router.oauth.google.authorize_access_token",
...
@pytest.mark.asyncio
@patch(
    "adapters.inbound.routes.login_router.oauth.google.authorize_redirect",
    new_callable=AsyncMock,
)
